...
function fillLeaderProfileForm() {
  ...
  document.getElementById("leaderSectionTitleInput").value = profile.sectionTitle || "";
  document.getElementById("leaderMainTitleInput").value = profile.title || "";
  document.getElementById("leaderNameInput").value = profile.name || "";
  document.getElementById("leaderPositionInput").value = profile.position || "";
  document.getElementById("leaderWelcomeInput").value = profile.welcomeText || "";
...
function initLeaderProfileForm() {
  ...
  form.addEventListener("submit", async (e) => {
    ...
    let finalPhotoUrl = (getVillageHeadProfile?.()?.photoUrl || "").trim();
    ...
    // Tombol A: simpan PROFIL saja, jangan mengubah statistik
    ...
    const updatedProfile = {
      sectionTitle: document.getElementById("leaderSectionTitleInput").value.trim(),
      title: document.getElementById("leaderMainTitleInput").value.trim(),
      name: document.getElementById("leaderNameInput").value.trim(),
      position: document.getElementById("leaderPositionInput").value.trim(),
      photoUrl: finalPhotoUrl,
      welcomeText: document.getElementById("leaderWelcomeInput").value.trim(),
      stats: existingStats
    };
...
function initSocialLinksForm() {
  ...
  form.addEventListener("submit", (e) => {
    ...
    saveSocialLinks({ youtube, instagram, facebook });
...
function initHeroSettingsForm() {
  ...
  form.addEventListener("submit", async (e) => {
    ...
    setMessage("Background hero berhasil disimpan. Silakan buka kembali website utama.", true);
